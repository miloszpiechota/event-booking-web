    ...
    <div className="bg-black/40 backdrop-blur-lg text-white p-8 rounded-2xl shadow-xl w-full space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { label: "First Name", val: firstName, setter: setFirstName, field: "firstName", placeholder: "John" },
            { label: "Last Name", val: lastName, setter: setLastName, field: "lastName", placeholder: "Doe" },
            { label: "Email", val: email, setter: setEmail, field: "email", placeholder: "example@mail.com", type: "email" },
            {
              label: "Phone Number", val: phoneNumber, setter: setPhoneNumber,
              field: "phoneNumber", placeholder: "567 890 123", isPhone: true
            }
          ].map(({ label, val, setter, field, placeholder, type = "text", isPhone }) => (
            <div key={field}>
